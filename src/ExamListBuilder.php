...
/**
 * Provides a list controller for the exam entity type.
 */
class ExamListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new ExamListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total exams: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\xvisus\Entity\ExamInterface $entity */
    $row['id'] = $entity->id();
